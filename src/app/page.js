    ...
    <div className="flex h-screen justify-between">
      <div className="w-full py-[3vw] px-[4vw] gap-[15vh] flex flex-col">
        ...
        <div className="flex flex-col justify-center gap-5">
          ...
          <input type="text" name="" id="" placeholder="Username" className="bg-white p-[10px] rounded-[10px]"/>
          <input type="text" name="" id="" placeholder="Password" className="bg-white p-[10px] rounded-[10px]"/>
          <p>Forgot Password</p>
